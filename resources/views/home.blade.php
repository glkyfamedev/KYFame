<x-homePage-layout>
    ...
    <div class="container border-bottom">
        <div class=" mt-4">
            ...
            <div class="row">
                <div class="col">
                    <img alt="" class="img-fluid" src="assets/twpPeople.png">
    ...
    <div class="container mt-4 border-bottom">
        <div class="row">
            ...
            <div class="col">
                <img src="assets/fame.png" class=" float-lg-end img-fluid" />
            </div>
        </div>
    </div>
                    ...
                    <div class="inner-section">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                ...
                                <a href="https://www.wave3.com/2019/05/17/jctc-graduates-go-pro-by-signing-with-local-manufacturing-companies/" target="_blank" rel="noopener noreferrer">
                                    More...
                                </a>
                            </div>
                        </div>
                        ...
                        <nav>
                            <div class="row linear-grid">
                                <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                                    <button class="nav-link active col-md-4" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                                        <img src="assets/jctcPrimaryinManufacturing.png" class="img-thumbnail">
                                    </button>

                                    <button class="nav-link col-md-4" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                                        <img src="/assets/KAM.png" class="img-thumbnail">
                                    </button>

                                    <button class="nav-link col-md-4" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">

                                        <img src="assets/studentSigning.png" class="img-thumbnail">
                                    </button>
