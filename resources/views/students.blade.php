<x-guest-layout>
    ...
    <header class="masthead student-masthead box-shadow-inset text-white mb-4">
    ...
    <div class="container px-lg-5" id="">
        ...
        <div class="row mx-lg-n5">
            <div class="col-md py-3 px-lg-5 order-2 order-md-1">
                ...
                <p class="">Click <a class="pink" id="studentActionLink" href="{{ URL('register') }}"><b>Sign Up</b> </a>
                ...
                <p class="text-center">
                    <i>To qualify for the FAME program Applicants need to be considered<span class="bg-main fw-bold"> college
                            ready</span></i> according to ACT/SAT/KYOTE scores or successful completion of pre-college courses.<br>
                </p>
            </div>
    ...
    <div class="container p-4">
        <div class="row p-lg-4">
            ...
            <div class=" col-lg my-lg-auto">
                <img src="assets/images/page-images/triangles.png" style="" class="h-lg-50 " />
            </div>
        </div>
    </div>
