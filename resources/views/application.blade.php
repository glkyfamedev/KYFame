                    ...
                    <div class="bg-white border-gray-200">
                            ...
                            <form class="contact-form row g-3" id="contact-Section" method="POST" action="{{ route('form.formSubmit') }}">
                                <input type="hidden" id="token" name="_token" value="{{ Session::token() }}">
                                    ...
                                    <div class="col-8 contact-required">
                                        ...
                                        <input id="streetAddress" class="form-control contact-input" type="text" name="streetAddress"
                                          required autofocus />
                                    </div>
                                    ...
                                    <div class="col-md-6 contact-required" >
                                     <label class="form-label contact-label" for="city">City <i class="bi bi-asterisk required"></i></label>
                                        <input id="city" class="form-control contact-input" type="text" name="city"
                                         required autofocus />
                                    </div>
                                    ...
                                    <div class="col-md-4 contact-required">
                                        ...
                                        <input id="state" class="form-control contact-input" type="text" name="state"
                                         required autofocus />
                                    </div>
                                    ...
                                    <div class="col-md-2 contact-required">
                                        ...
                                        <input id="zip" class="form-control contact-input" type="text" name="zip"
                                          required autofocus />
                                    </div>

                                    <div class="col contact-required">
                                        <label class="form-label contact-label" for="phone">Primary Phone <i class="bi bi-asterisk required"></i></label>
                                        <input id="primaryPhone" class="form-control contact-input phone" type="text" name="primaryPhone"
                                          required autofocus />
                                    </div>
                                    <div class="col">
                                        <label class="form-label contact-label" for="altPhone">Alt Phone</label>
                                        <input id="altPhone" class="form-control phone" type="text" name="altPhone"
                                         autofocus />
                                    </div>                                                             
                                    <div class="form-nav">
                                      <button type="submit" id="contactBtn" class="nextBtn btn btn-info float-right"data-section="1">Next</button>
                                  </div>
                                </form>
                        </div>
                        ...
                        <div class="form-section toggle" id="section2" style="display:none;">
                         <h2>Legal status </h2>
                            <form class="Contact-form" method="POST" action="{{ route('form.formStatus') }}">
                                ...
                                <h5 for="authorizedInUs">Are you authorized to work in the US? <i class="bi bi-asterisk required"></i></h5>
                                ...
                                <h5 for="levelOfEducation">What is your highest level of Education? <i class="bi bi-asterisk required"></i></h5>
                                ...
                                <h5 for="RelativesAtSponsors">Do you have an relatives working for sponsoring companies? <i class="bi bi-asterisk required"></i></h5>
                                ...
                                <div class="m-3 hide status-required" id="relativeSponsorInput">
                                    <label for="relativeSponsorNames" class="form-label status-label">If you answered yes to the previous question please enter that sponor name here.<i class="bi bi-asterisk required"></i> </label>
                                    <input id="relativeSponsorNames" class="form-control" type="text" name="" autofocus />
                                </div>


                                <h5 for="employedWithSponsor">Do you work for a sponsoring company? <i class="bi bi-asterisk required"></i></h5>
                                ...
                                <div class="m-3 hide status-required" id="employedSponsorInput">
                                    <label for="employedSponsorNames" class="form-label status-label">If you answered yes to the previous question please enter that sponor name here.<i class="bi bi-asterisk required"></i> </label>
                                    <input id="employedSponsorNames" class="form-control" type="text" name="" autofocus />
                                </div>

                                <div class="form-nav m-3">
                                    <button type="submit" id="statusBtn" class="nextBtn btn btn-info float-right" data-section="2">Next</button>                                    
                                </div>                          
                            </form>
                        </div>
                        ...
                        <div class="form-section toggle" style="display:none;" id="section3">
                           <h2>Employment History</h2>
                            ...
                            <div class="col-md-2 mb-3 mt-4" id="addButton">
                                <button class="btn btn-primary" type="button" style="width:140px;" id="addField">Add Employer</button>
                            </div>

                            <div class="form-nav">
                                
                                <button type="submit" id="employmentBtn" class="btn btn-info float-right" data-section="3">Next</button>
                            </div>
                        </div>
                        ...
                        <div class="form-section toggle" id="section4" style="display: none" ;>
                           <h2> Assessments</h2>                          
                               <form class="contact-form" method="post" action="{{ route('form.formAssesments') }}">
                                        ...
                                        <div id="ACTScoresContainer" class="hide">
                                            ...
                                            <div id="ACTScores"  class="row score-required" style="display: inline-flex;">
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control ACT testScore" id="ACTenglishScore" name="ACTenglishScore"
                                                     placeholder="English" />
                                                </div>
                                                <div class="col">
                                                    <label class="score-label" for="ACTreadingScore"></label>
                                                    <input type="text" class="form-control testScore ACT" id="ACTreadingScore" name="ACTreadingScore"
                                                         placeholder="Reading" />
                                                </div>
                                                <div class="col">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control testScore ACT" id="ACTscienceScore" name="ACTscienceScore"
                                                        placeholder="Science" />
                                                </div>
                                                <div class="col">
                                                    <label class="score-label" for="ACTcompositeScore"></label>
                                                    <input type="text" class="form-control testScore ACT" id="ACTcompositeScore" name="ACTcompositeScore"
                                    ...
                                    <div class="form-nav m-3">                                       
                                        <button type="submit" id="assesmentBtn" class=" btn btn-info float-right" data-section="4">Next</button>
                                    </div>
                            ...
                            <form class="contact-form"> 
                             <input type="hidden" id="essayToken" name="_token" value="{{ Session::token() }}">
                              <div id="essay-required">
                                ...
                                <div  class="form-nav">                                
                                    <button type="submit" id="essayBtn" class="nextBtn btn btn-info float-right" data-section="5">Next</button>
                                </div>
                              </div>
                            </form>
                        </div>
                        ...
                        <div class="form-section toggle" id="section6" style="display:none" ;>
                             <h2> Transcripts</h2>                              
                                ...
                                <p> Select a method for submiting your transcripts. <i>Transcripts must be submited within 14 days of completeing the application</i></p> 
                                ...
                                <div class="transctiptMethod">
                                    ...
                                    <div class="p-3">
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input transcript" type="radio" id="sendEmail" name="transcriptMethod" value="uploadTranscripts">
                                        </div>
                                    ...
                                    <div class="p-3">
                                        <div class="form-check">
                                                <label class="form-check-label" for="sendEmail">Send transctipts through Email </label>
                                    ...
                                    <div class="p-3">
                                        <div class="form-check">
                                                <label class="form-check-label" for="sendLater">I will submit my transcripts within 14 days of submiting my application </label>
                                 ...
                                 <div class="form-nav">                                  
                                    <button type="submit" id="transcriptBtn" class="nextBtn btn btn-info float-right" data-section="6">Next</button>
                                </div>
                            </form>
                        </div>
